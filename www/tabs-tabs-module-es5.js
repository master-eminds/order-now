...
var Toast = _capacitor_core__WEBPACK_IMPORTED_MODULE_7__["Plugins"].Toast;
var TabsPage = /** @class */ (function () {
    function TabsPage(barcodeScanner, route, authService) {
        ...
        _ionic_native_keyboard__WEBPACK_IMPORTED_MODULE_1__["Keyboard"].onKeyboardWillHide().subscribe(function () {
            _this.scanBtn.el.style.visibility = 'visible';
        });
        _ionic_native_keyboard__WEBPACK_IMPORTED_MODULE_1__["Keyboard"].onKeyboardDidShow().subscribe(function () {
            _this.scanBtn.el.style.visibility = 'hidden';
        });
    }

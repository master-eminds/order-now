...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, translate, authService, router, menuController) {
...
var AuthService = /** @class */ (function () {
    function AuthService(router) {
        ...
        Storage.get({ key: 'currentUser' }).then(function (res) {
            _this.currentUserSubject = new rxjs__WEBPACK_IMPORTED_MODULE_3__["BehaviorSubject"](JSON.parse(res.value));
...
var RoutingInterceptior = /** @class */ (function () {
    function RoutingInterceptior(router, authService) {
        this.router = router;
        this.authService = authService;
    }
    RoutingInterceptior.prototype.canActivate = function () {
    ...
    RoutingInterceptior.ctorParameters = function () { return [
